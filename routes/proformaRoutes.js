...
router.get("/:id", verifyClientOrAdmin, proformaController.getProformaEntryById);

// router.post("/:id/pdf", verifyClientOrAdmin, proformaController.uploadTempPdf);
// router.get("/:id/pdf", verifyClientOrAdmin, proformaController.serveTempPdf);
