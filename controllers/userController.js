  ...
  try {
    ...
    if (roleId || roleName) {
      ...
      if (isDifferent) {
        ...
        if (global.io) {
          global.io.to(`user-${doc._id}`).emit("force-logout", {
            message:
              "Admin has updated your role. Please login again to sync permissions.",
          });
        }
...
exports.loginUser = async (req, res) => {
  try {
    ...
    if (platform !== "mobile") {
      ...
      console.log("📱 Skipping reCAPTCHA for User App login");
    }
