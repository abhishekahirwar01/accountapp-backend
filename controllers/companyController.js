...
exports.createCompany = async (req, res) => {
  try {
    ...
    const company = new Company({
      ...
      showLogoBorder: showLogoBorder !== undefined ? showLogoBorder : true,
    });
...
if (showLogoBorder !== undefined) {
  company.showLogoBorder = showLogoBorder;
}
    // Logo update logic
    if (req.file && req.file.path) {
...
if (req.body.defaultNotes !== undefined) {
  company.defaultNotes = req.body.defaultNotes;
}
